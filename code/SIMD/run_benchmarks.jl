...
## run benchmarks
polydegs = 3:15
# run_benchmarks(polydegs, 2, flux_shima_etal_turbo, flux_shima_etal)
# run_benchmarks(polydegs, 2, flux_ranocha_turbo, flux_ranocha)

# run_benchmarks(polydegs, 3, flux_shima_etal_turbo, flux_shima_etal)
# run_benchmarks(polydegs, 3, flux_ranocha_turbo, flux_ranocha)
